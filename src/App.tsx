            ...
            <Droppable direction="vertical" droppableId={item[0]}>
              {(provided, snapshot) => {
                const computedCardStyle =
                  item[0] === "BACKLOG"
                    ? { ...STYLES.CARD_BASE, ...STYLES.CARD_BACKLOG }
                    : item[0] === "COMPLETED"
                    ? { ...STYLES.CARD_BASE, ...STYLES.CARD_IN_PROGRESS }
                    : { ...STYLES.CARD_BASE, ...STYLES.CARD_COMPLETE };

                const additionalColumnStyle = snapshot.isDraggingOver
                  ? {
                      backgroundColor: "#c0e7f7",
                    }
                ...
                return (
                  <div
                    ...
                    style={{ ...STYLES.COLUMN, ...additionalColumnStyle }}
                  >
                    <h2>{item[0]}</h2>
